...
module SwaggerClient
  class FundingApi
    ...
    def funding_get(opts = {})
      data, _status_code, _headers = funding_get_with_http_info(opts)
      return data
    end
    ...
    # @option opts [DateTime] :start_time Starting date filter for results.
    # @option opts [DateTime] :end_time Ending date filter for results.
    # @return [Array<(Array<Funding>, Fixnum, Hash)>] Array<Funding> data, response status code and response headers
    def funding_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: FundingApi.funding_get ..."
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Array<Funding>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FundingApi#funding_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
