...
module SwaggerClient
  class SettlementApi
    ...
    def settlement_get(opts = {})
      data, _status_code, _headers = settlement_get_with_http_info(opts)
      return data
    end
    ...
    # @option opts [DateTime] :start_time Starting date filter for results.
    # @option opts [DateTime] :end_time Ending date filter for results.
    # @return [Array<(Array<Settlement>, Fixnum, Hash)>] Array<Settlement> data, response status code and response headers
    def settlement_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: SettlementApi.settlement_get ..."
      end
      # resource path
      local_var_path = "/settlement"
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Array<Settlement>')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SettlementApi#settlement_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
