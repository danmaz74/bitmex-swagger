...
module SwaggerClient
  class LiquidationApi
    ...
    def liquidation_get(opts = {})
      data, _status_code, _headers = liquidation_get_with_http_info(opts)
      return data
    end
    ...
    # @option opts [DateTime] :start_time Starting date filter for results.
    # @option opts [DateTime] :end_time Ending date filter for results.
    # @return [Array<(Array<Liquidation>, Fixnum, Hash)>] Array<Liquidation> data, response status code and response headers
    def liquidation_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: LiquidationApi.liquidation_get ..."
      end
      # resource path
      local_var_path = "/liquidation"
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LiquidationApi#liquidation_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
